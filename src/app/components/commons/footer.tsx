...
const Footer = () => {
  return (
    <>
      <footer className="border-black border-t-1 bg-orange-primary hidden lg:block">
      ...
      {/* Footer mobile */}
      <div className="block lg:hidden bg-orange-primary border-t-1 border-black">
        <footer className="">
          <Link href="/" className="flex justify-center py-4 px-2">
            <Image src="/sos-logo.png" width={67} height={70} alt="SOS logo" />
          </Link>
          <div className="bg-orange-secondary p-3">
            <p className="font-light font-readex text-xs text-center">
              Desenvolvido por{" "}
              <Link href="/" className="font-bold uppercase">
                ATS Web Solution
              </Link>{" "}
